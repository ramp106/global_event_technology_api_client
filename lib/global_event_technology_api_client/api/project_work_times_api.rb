...
module GlobalEventTechnologyApiClient
  class ProjectWorkTimesApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfWorkTimeModel, Fixnum, Hash)>] ArrayResultOfWorkTimeModel data, response status code and response headers
    def project_work_times_get_all_with_http_info(project_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfWorkTimeModel')
      if @api_client.config.debugging
    ...
    # @param work_time_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkTimeModel, Fixnum, Hash)>] WorkTimeModel data, response status code and response headers
