...
module GlobalEventTechnologyApiClient
  class ProjectTransactionsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [TransactionModel]
    def project_transactions_refund(body, project_id, transaction_id, opts = {})
      data, _status_code, _headers = project_transactions_refund_with_http_info(body, project_id, transaction_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TransactionModel, Integer, Hash)>] TransactionModel data, response status code and response headers
    def project_transactions_refund_with_http_info(body, project_id, transaction_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectTransactionsApi.project_transactions_refund ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ProjectTransactionsApi.project_transactions_refund"
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
