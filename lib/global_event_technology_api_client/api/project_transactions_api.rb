...
module GlobalEventTechnologyApiClient
  class ProjectTransactionsApi
    ...
    # @param transaction_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TransactionModel, Fixnum, Hash)>] TransactionModel data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @return [TransactionModel]
    def project_transactions_refund(project_id, transaction_id, request_model, opts = {})
      data, _status_code, _headers = project_transactions_refund_with_http_info(project_id, transaction_id, request_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TransactionModel, Fixnum, Hash)>] TransactionModel data, response status code and response headers
    def project_transactions_refund_with_http_info(project_id, transaction_id, request_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectTransactionsApi.project_transactions_refund ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling ProjectTransactionsApi.project_transactions_refund"
      end
      # verify the required parameter 'transaction_id' is set
      if @api_client.config.client_side_validation && transaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'transaction_id' when calling ProjectTransactionsApi.project_transactions_refund"
      end
      # verify the required parameter 'request_model' is set
      if @api_client.config.client_side_validation && request_model.nil?
        fail ArgumentError, "Missing the required parameter 'request_model' when calling ProjectTransactionsApi.project_transactions_refund"
      end
      # resource path
      local_var_path = '/projects/{projectId}/transactions/{transactionId}/refund'.sub('{' + 'projectId' + '}', project_id.to_s).sub('{' + 'transactionId' + '}', transaction_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'TransactionModel')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectTransactionsApi#project_transactions_refund\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
