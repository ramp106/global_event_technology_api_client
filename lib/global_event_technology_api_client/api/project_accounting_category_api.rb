...
module GlobalEventTechnologyApiClient
  class ProjectAccountingCategoryApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfAccountingCategoryModel, Fixnum, Hash)>] ArrayResultOfAccountingCategoryModel data, response status code and response headers
    def project_accounting_category_get_all_with_http_info(project_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfAccountingCategoryModel')
      if @api_client.config.debugging
    ...
    # @param accounting_category_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AccountingCategoryModel, Fixnum, Hash)>] AccountingCategoryModel data, response status code and response headers
    def project_accounting_category_get_by_id_with_http_info(project_id, accounting_category_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'AccountingCategoryModel')
      if @api_client.config.debugging
