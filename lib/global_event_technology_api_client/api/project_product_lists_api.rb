...
module GlobalEventTechnologyApiClient
  class ProjectProductListsApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfProductListModel, Fixnum, Hash)>] ArrayResultOfProductListModel data, response status code and response headers
    def project_product_lists_get_all_with_http_info(project_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfProductListModel')
      if @api_client.config.debugging
