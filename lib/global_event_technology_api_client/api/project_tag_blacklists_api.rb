...
module GlobalEventTechnologyApiClient
  class ProjectTagBlacklistsApi
    ...
    def project_tag_blacklists_get_status(project_id, tag_nr, tag_session_counter, opts = {})
      data, _status_code, _headers = project_tag_blacklists_get_status_with_http_info(project_id, tag_nr, tag_session_counter, opts)
      data
    end
    ...
    def project_tag_blacklists_get_status_with_http_info(project_id, tag_nr, tag_session_counter, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProjectTagBlacklistsApi.project_tag_blacklists_get_status ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling ProjectTagBlacklistsApi.project_tag_blacklists_get_status"
      end
      # verify the required parameter 'tag_nr' is set
      if @api_client.config.client_side_validation && tag_nr.nil?
        fail ArgumentError, "Missing the required parameter 'tag_nr' when calling ProjectTagBlacklistsApi.project_tag_blacklists_get_status"
      end
      ...
      if @api_client.config.client_side_validation && tag_session_counter.nil?
        fail ArgumentError, "Missing the required parameter 'tag_session_counter' when calling ProjectTagBlacklistsApi.project_tag_blacklists_get_status"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProjectTagBlacklistsApi#project_tag_blacklists_get_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param body 
