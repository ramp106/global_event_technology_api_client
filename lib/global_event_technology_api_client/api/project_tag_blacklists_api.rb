...
module GlobalEventTechnologyApiClient
  class ProjectTagBlacklistsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def project_tag_blacklists_update_black_list_for_tag(project_id, tag_nr, tag_session_counter, args, opts = {})
      project_tag_blacklists_update_black_list_for_tag_with_http_info(project_id, tag_nr, tag_session_counter, args, opts)
      nil
    end
    ...
    def project_tag_blacklists_update_black_list_for_tag_with_http_info(project_id, tag_nr, tag_session_counter, args, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && args.nil?
        fail ArgumentError, "Missing the required parameter 'args' when calling ProjectTagBlacklistsApi.project_tag_blacklists_update_black_list_for_tag"
      end
      # resource path
      local_var_path = '/projects/{projectId}/tag-blacklists/{tagNr}/{tagSessionCounter}'.sub('{' + 'projectId' + '}', project_id.to_s).sub('{' + 'tagNr' + '}', tag_nr.to_s).sub('{' + 'tagSessionCounter' + '}', tag_session_counter.to_s)
