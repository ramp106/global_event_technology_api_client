...
module GlobalEventTechnologyApiClient
  class ProjectTagStatesApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfCurrentTagStateModel, Fixnum, Hash)>] ArrayResultOfCurrentTagStateModel data, response status code and response headers
    def project_tag_states_get_all_with_http_info(project_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfCurrentTagStateModel')
      if @api_client.config.debugging
    ...
    # @param session_counter 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CurrentTagStateModel, Fixnum, Hash)>] CurrentTagStateModel data, response status code and response headers
    def project_tag_states_get_for_tag_and_session_counter_with_http_info(project_id, tag_nr, session_counter, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'CurrentTagStateModel')
      if @api_client.config.debugging
