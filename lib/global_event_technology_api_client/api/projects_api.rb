...
module GlobalEventTechnologyApiClient
  class ProjectsApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfProjectModel, Fixnum, Hash)>] ArrayResultOfProjectModel data, response status code and response headers
    def projects_get_all_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfProjectModel')
      if @api_client.config.debugging
