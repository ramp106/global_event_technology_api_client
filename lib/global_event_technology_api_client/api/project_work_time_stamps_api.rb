...
module GlobalEventTechnologyApiClient
  class ProjectWorkTimeStampsApi
    ...
    # @option opts [Integer] :limit 
    # @option opts [String] :_next 
    # @return [Array<(ArrayResultOfWorkTimeStampModel, Fixnum, Hash)>] ArrayResultOfWorkTimeStampModel data, response status code and response headers
    def project_work_time_stamps_get_all_with_http_info(project_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ArrayResultOfWorkTimeStampModel')
      if @api_client.config.debugging
    ...
    # @param work_time_stamp_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WorkTimeStampModel, Fixnum, Hash)>] WorkTimeStampModel data, response status code and response headers
    def project_work_time_stamps_get_by_id_with_http_info(project_id, work_time_stamp_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'WorkTimeStampModel')
      if @api_client.config.debugging
