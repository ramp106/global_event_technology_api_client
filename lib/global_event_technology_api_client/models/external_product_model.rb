...
module GlobalEventTechnologyApiClient
  class ExternalProductModel
    ...
    def list_invalid_properties
      ...
      if @tax_rate_id.nil?
        invalid_properties.push('invalid value for "tax_rate_id", tax_rate_id cannot be nil.')
      end

      if @accounting_category_id.nil?
        invalid_properties.push('invalid value for "accounting_category_id", accounting_category_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tax_rate_id.nil?
      return false if @accounting_category_id.nil?
      true
    end
    ...
    def hash
      [name, price_in_credits, enable_field_query, field_query, color, ean, tax_rate_id, accounting_category_id].hash
    end
