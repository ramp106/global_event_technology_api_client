...
module GlobalEventTechnologyApiClient
  class UnitModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accessNumber')
        self.access_number = attributes[:'accessNumber']
      end
      ...
      if attributes.has_key?(:'managerQuery')
        self.manager_query = attributes[:'managerQuery']
      end
