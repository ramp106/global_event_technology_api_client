...
module GlobalEventTechnologyApiClient
  class ExternalTicketModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'master_barcode')
        self.master_barcode = attributes[:'master_barcode']
      end
    end
    ...
    def hash
      [barcode, external_id, allowed_visits, given_name, family_name, email, ticket_type_id, ticket_type_alias, source_name, company_name, role, pre_gift_credits, pure_gift_credits, normal_gift_credits, details, phone, gender, street, zip_code, city, country, date_of_birth, unit_id, master_barcode].hash
    end
