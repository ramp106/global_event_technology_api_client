...
module GlobalEventTechnologyApiClient
  class ProductsModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productListId')
        self.product_list_id = attributes[:'productListId']
      end
    ...
    def hash
      [id, project_id, update_date, name, product_list_id, price_in_credits, enable_field_query, field_query, color, ean, accounting_category_id, tax_rate_id].hash
    end
