...
module GlobalEventTechnologyApiClient
  class ExternalPayoutArgsModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'donate_credits')
        self.donate_credits = attributes[:'donate_credits']
      end

      if attributes.key?(:'donate_all')
        self.donate_all = attributes[:'donate_all']
      end
