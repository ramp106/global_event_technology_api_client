...
module GlobalEventTechnologyApiClient
  class TicketModel
    ...
    def hash
      [id, external_id, ticket_type_name, ticket_type_alias, cancelled, update_date, real_credits, gift_credits, details, barcode, given_name, family_name, email, company_name, role, phone, gender, street, zip_code, city, country, source_name, master_barcode].hash
    end
