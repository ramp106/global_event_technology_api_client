...
module GlobalEventTechnologyApiClient
  class CompanyModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'addressStreet')
        self.address_street = attributes[:'addressStreet']
      end

      if attributes.has_key?(:'addressPostalCode')
        self.address_postal_code = attributes[:'addressPostalCode']
      end
      ...
      if attributes.has_key?(:'steuernummer')
    ...
    def hash
      [project_id, id, name, unit_id, address_street, address_postal_code, address_city, address_country_iso, vat_id, gln, steuernummer, contact_name, contact_email, update_date].hash
    end
