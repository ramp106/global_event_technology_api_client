...
```shell
gem install ./global_event_technology_api_client-1.8.0.gem
```
(for development, run `gem install --dev ./global_event_technology_api_client-1.8.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'global_event_technology_api_client', '~> 1.8.0'
